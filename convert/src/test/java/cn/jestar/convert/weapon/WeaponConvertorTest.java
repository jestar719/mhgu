...
public class WeaponConvertorTest {
    ...
    public void translateSword() throws Exception {
        new WeaponConvertor("大剑").translation();
    }
    ...
    public void translateChangQiang() throws Exception {
        new WeaponConvertor("长枪").translation();
    }
    ...
    public void translateDaChui() throws Exception {
        new WeaponConvertor("大锤").translation();
    }
     ...
     */
    @Test
    public void translateZhanFu() throws Exception {
        new WeaponConvertor("斩击斧").translation();
    }
}
